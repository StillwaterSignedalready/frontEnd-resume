...
var _CoverPage = __webpack_require__(28);

var _CoverPage2 = _interopRequireDefault(_CoverPage);

var _ProjectPage = __webpack_require__(29);

var _ProjectPage2 = _interopRequireDefault(_ProjectPage);

var _SkillsPage = __webpack_require__(30);
...
var App = function (_React$Component) {
	...
	_createClass(App, [{
		...
		key: 'judgeClassName',
		value: function judgeClassName() {
			return 1;
		}
	}, {
		key: 'pickPage',
		value: function pickPage(pageNumber, className) {
			switch (pageNumber % 3) {
				case -1:
					return null;
				case 0:
					return _react2.default.createElement(_CoverPage2.default, { className: className });
				case 1:
					return _react2.default.createElement(_ProjectPage2.default, { className: className, projects: this.state.projects });
				case 2:
					return _react2.default.createElement(_SkillsPage2.default, { className: className, skills: this.state.skills });
			}
		}
   ...
   */
		...
		value: function render() {
			var classNames = ['previous-page', 'previous-page', 'previous-page'];
			classNames[this.state.currentPage] = '';

			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_CoverPage2.default, { className: classNames[0] }),
				_react2.default.createElement(_ProjectPage2.default, { className: classNames[1], projects: this.state.projects }),
				_react2.default.createElement(_SkillsPage2.default, { className: classNames[2], skills: this.state.skills })
			);
		}
	}]);
...
var CoverPage = function (_React$Component) {
	_inherits(CoverPage, _React$Component);

	function CoverPage() {
		_classCallCheck(this, CoverPage);

		return _possibleConstructorReturn(this, (CoverPage.__proto__ || Object.getPrototypeOf(CoverPage)).apply(this, arguments));
	}

	_createClass(CoverPage, [{
		key: 'render',
		value: function render() {
			var className = 'wrapper ' + (this.props.className || ' ');
			console.log(className);
			return _react2.default.createElement(
				'div',
				{ className: className, onWheel: this.props.onScroll },
				...
				_react2.default.createElement(
					'a',
					{ href: 'http://blog.csdn.net/sinat_34991877' },
					'My Blog'
				)
			);
		}
	...
	_createClass(ProjectPage, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					projects.map(function (project) {
						return _react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ href: project.link, className: 'project-name' },
								project.name
							),
							_react2.default.createElement(
								'div',
				...
				_react2.default.createElement(
					'a',
					{ className: 'github', href: 'http://blog.csdn.net/sinat_34991877' },
					'\u66F4\u591A\u9879\u76EE\u8BF7\u79FB\u6B65GitHub'
				)
			);
		}
...
var SkillsPage = function (_React$Component) {
	...
	function SkillsPage() {
		...
		return _possibleConstructorReturn(this, (SkillsPage.__proto__ || Object.getPrototypeOf(SkillsPage)).apply(this, arguments));
	}
   ...
   */
		value: function cutChunkOfArray(array, size) {
			var newArray = [];
		...
		key: 'render',
		value: function render() {
			var skills = JSON.parse(JSON.stringify(this.props.skills));
			var className = 'wrapper ' + (this.props.className || ' ');
			return _react2.default.createElement(
				'div',
				{ className: className, onWheel: this.props.onScroll },
				...
				_react2.default.createElement(
					'div',
					{ className: 'skill-bar' },
					this.cutChunkOfArray(skills, 2).map(function (skillName) {
						return _react2.default.createElement(
							'span',
							{ className: 'skill', key: skillName },
							skillName
						);
					})
				),
				_react2.default.createElement(
					'div',
					{ className: 'skill-bar' },
					this.cutChunkOfArray(skills, 5).map(function (skillName) {
						return _react2.default.createElement(
							'span',
							{ className: 'skill', key: skillName },
							skillName
				...
				_react2.default.createElement(
					'div',
					{ className: 'skill-bar' },
					this.cutChunkOfArray(skills, 3).map(function (skillName) {
						return _react2.default.createElement(
							'span',
							{ className: 'skill', key: skillName },
							skillName
